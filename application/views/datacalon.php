                    ...
                    <div class="modal-content">
                        ...
                        <form action="datacal/insert" method="post">
                            <div class="modal-body">
                                ...
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="disabled-input" class=" form-control-label">Divisi</label></div>
                                    <div class="col-12 col-md-9">
                                        <select name="divisi" id="divisi" class="form-control">
                                            <?php $no = 1;
                                            foreach ($data_divisi->result_array() as $i) {
                                                echo "<option value='" . $i['id_divisi'] . "' >" . $i['nama_divisi'] . "</option>";
                                            }
                                            ?>
                                        </select>
                                    </div>
                    ...
                    <div class="modal-dialog modal-md" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h2><i class="fa fa-pencil"></i>&nbsp; Calon</h2>
                            </div>
                            ...
                            <form action="<?php echo site_url('datacal/edit/' . $id); ?>" method="post">
                                <div class="modal-body">
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="disabled-input" class=" form-control-label">Nama</label></div>
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="namacalon" name="namacalon" placeholder="Nama Calon" class="form-control" value="<?php echo $namacalon; ?>">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="disabled-input" class=" form-control-label">Visi</label></div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <select name="divisi" id="divisi" class="form-control">
                                                ...
                                                foreach ($data_divisi->result_array() as $i) {
                                                ?>
                                                    <option value="<?php echo $i['id_divisi']; ?>" <?php if ($i['id_divisi'] == $id_divisi) {
                                                                                                        echo 'selected';
                                                                                                    }  ?>>
                                                        <?php echo $i['nama_divisi'] ?>
                                                    </option>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="staticModalLabel">Jika Anda menghapus semua data Calon maka
                                pilihan siswa juga akan direset...
                                <hr>Apakah anda yakin ingin menghapus semua data calon ?
                            </h5>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Tidak</button>
